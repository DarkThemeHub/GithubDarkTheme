...
if (false || (new RegExp("^https?:\/\/(((?!desktop).*\.)?(githubusercontent|githubstatus|github)\.(?!io|myshopify|blog|community)).*")).test(document.location.href))
	css += [
		...
		"  --color-calendar-graph-day-L4-bg: rgba(67, 130, 195, 1);",
		"  --color-project-sidebar-bg: #25272a;",
		"  --color-notifications-row-read-bg: #25272a;",
		"  --color-notifications-button-hover-bg: transparent; }",
		"",
		"html {",
